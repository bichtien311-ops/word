...
def add_figure(doc: Document, image_path: str, caption_text: str,
    ...
    if not os.path.isabs(image_path):
        # путь относительно корня проекта (на уровень выше execution)
    ...
    # Параграф с картинкой, по центру
    ...
    # Подбираем ширину: не больше max_width_cm и не растягиваем мелкие
    try:
